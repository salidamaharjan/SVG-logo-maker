...
<text x="70" y="80" font-size="40" font-weight="bold" text-anchor="middle" alignment-baseline="middle" fill="#000000">${this.word}</text>
</svg>`;
  }
}
/**
...
class Square extends Shape {
  ...
  draw() {
    return `
<svg>
<rect x="10" y="10" width="120" height="120"  fill=${shapeColo} />
<text x="70" y="70" font-size="40" font-weight="bold" text-anchor="middle" alignment-baseline="middle" fill="#000000">${this.word}</text>
</svg>`;
  }
}

...
<text x="70" y="80" font-size="40" font-weight="bold" text-anchor="middle" alignment-baseline="middle" fill="#000000">${word}</text>
</svg>`);
    })
})
...
<text x="70" y="70" font-size="40" font-weight="bold" text-anchor="middle" alignment-baseline="middle" fill="#000000">${word}</text>
</svg>`);
    })
})